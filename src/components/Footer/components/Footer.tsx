      ...
      <div className=" layout component-padding">
        <div className="flex flex-col gap-6">
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-4 lg:items-center text-[14px]">
                      {data?.subHeading?.map((subdata, index) => {
                        return (
                          <div key={index} className="transition-all relative group hover:-translate-y-[5px] hover:text-[#632115]">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div> ©School 2024, All rights reserved. Developed By <a href="https://nextaussietech.com/" target="_blank" className="font-semibold underline hover:text-[#632115] transition-all relative group hover:-translate-y-[2px]">Next Aussie Tech</a></div>
          </div>
        </div>
      </div>
    </div>
