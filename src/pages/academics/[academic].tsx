          ...
          <div className="grid lg:grid-cols-8">
            <div className="lg:col-span-5 flex flex-col gap-10">
              ...
              <div className="text-[18px] leading-[25px]">
                ...
                extracurricular activities. At the secondary level, academic
                programs often become more specialized, allowing students to
                delve deeper into specific fields of interest through advanced
                coursework, elective options, and extracurricular programs such
                as honors classes, Advanced Placement (AP) courses, and career
                and technical education (CTE) pathways. These programs aim to
                not only impart knowledge but also to foster critical thinking,
                creativity, and a lifelong passion for learning. Through a
                combination of classroom instruction, hands-on activities, and
                real-world experiences, academic programs within schools strive
                to prepare students for success in higher education, the
